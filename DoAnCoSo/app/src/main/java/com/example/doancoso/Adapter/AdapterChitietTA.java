...
public class AdapterChitietTA extends ArrayAdapter<ChitietTA> {
    private final Activity context;
    int resource;

    public AdapterChitietTA(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ChitietTA thucAnModel =getItem(position);
